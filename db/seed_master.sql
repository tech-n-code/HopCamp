...
INSERT INTO tentsites (name, available, demand, instantBook, descriptions, capacity, restrictions, amenities, price, type, imgURL)
VALUES ('Wildwood Retreat', 3, 'High', true, 'Escape to the serene Wildwood Retreat surrounded by lush greenery.', 4, 'No pets allowed', 'Fire pit, Picnic table', 50.00,'RV/tent site','https://hipcamp-res.cloudinary.com/f_auto,c_limit,w_550,q_auto/v1447144043/campground-photos/deqddjjea4ilhirvyzai.jpg');

INSERT INTO tentsites (name, available, demand, instantBook, descriptions, capacity, restrictions, amenities, price, type, imgURL)
VALUES ('Serenity Springs', 3, 'Medium', true, 'Experience tranquility at Serenity Springs, where you can unwind and rejuvenate.', 6, 'Quiet hours between 10 PM and 7 AM', 'Hiking trails, Fishing spot', 60.00,'RV/tent site','https://hipcamp-res.cloudinary.com/f_auto,c_limit,w_550,q_auto/v1447142515/campground-photos/rd7dvfnczgfeiehtabxm.jpg');

-- INSERT INTO tentsites (name, available, demand, instantBook, descriptions, capacity, restrictions, amenities, price, type, imgURL)
-- VALUES ('Whispering Pines', 6, 'Low', false, 'Discover the magic of Whispering Pines, surrounded by towering pine trees.', 3, NULL, 'Campfire ring, BBQ grill', 40.00,'RV/tent site','https://hipcamp-res.cloudinary.com/f_auto,c_limit,w_550,q_auto/v1447813372/campground-photos/b67zkjgrdgim0zrwe1dp.jpg');

INSERT INTO tentsites (name, available, demand, instantBook, descriptions, capacity, restrictions, amenities, price, type, imgURL)
VALUES ('Mountain Vista', 3, 'High', true, 'Enjoy breathtaking views from Mountain Vista, where adventure awaits.', 8, 'No smoking allowed', 'Scenic overlook, Wildlife spotting', 75.00,'RV/tent site','https://hipcamp-res.cloudinary.com/f_auto,c_limit,w_550,q_auto/v1447144254/campground-photos/hb94pn0mjd51zlnnl53w.jpg');

INSERT INTO tentsites (name, available, demand, instantBook, descriptions, capacity, restrictions, amenities, price, type, imgURL)
VALUES ('Lakeside Haven', 4, 'Medium', false, 'Experience serenity at Lakeside Haven, nestled by a pristine lake.', 5, 'Pets allowed on leash', 'Kayaking, Fishing dock', 55.00,'RV/tent site','https://hipcamp-res.cloudinary.com/f_auto,c_limit,w_550,q_auto/v1541964948/campground-photos/wxy1q7nw0z6mtvxsscbi.jpg');

INSERT INTO tentsites (name, available, demand, instantBook, descriptions, capacity, restrictions, amenities, price, type, imgURL)
VALUES ('Eagle’s Nest Treehouse Farmstay', 6, 'High', true, 'The Eagle’s Nest Treehouse Farm Stay offers a secluded, tranquil wilderness experience, right in the middle of a private forest, but with many of the comforts of a well-appointed guest house 40 feet from the ground.', 2, 'No pets', 'Nature trails, Picnic area', 45.00,'Lodging','https://hipcamp-res.cloudinary.com/f_auto,c_limit,w_550,q_auto/v1476482092/campground-photos/abvqx8gl26smow3uxgk8.jpg');

-- INSERT INTO tentsites (name, available, demand, instantBook, descriptions, capacity, restrictions, amenities, price, type, imgURL)
-- VALUES ('Adventure Point', 3, 'High', true, 'Embark on an unforgettable adventure at Adventure Point, the ultimate outdoor playground.', 10, NULL, 'Rock climbing wall, Zipline', 80.00,'RV/tent site','https://hipcamp-res.cloudinary.com/f_auto,c_limit,w_550,q_auto/v1497721193/campground-photos/oqq2njs5fhk4vk9hnp9f.jpg');

-- INSERT INTO tentsites (name, available, demand, instantBook, descriptions, capacity, restrictions, amenities, price, type, imgURL)
-- VALUES ('Moonlit Grove', 2, 'Medium', false, 'Experience the enchantment of the Moonlit Grove, surrounded by ancient trees.', 4, NULL, 'Campfire circle, Stargazing platform', 60.00,'RV/tent site','https://hipcamp-res.cloudinary.com/f_auto,c_limit,w_550,q_auto/v1663879875/land-photos/iu9v83bpir6p0x9k9hbi.png');
...
INSERT INTO tentsites (name, available, demand, instantBook, descriptions, capacity, restrictions, amenities, price, type, imgURL)
VALUES ('Rustic Oasis', 4, 'Medium', true, 'Escape to the Rustic Oasis, a hidden gem nestled in nature.', 3, NULL, 'Hammock, BBQ area', 50.00,'RV/tent site','https://hipcamp-res.cloudinary.com/f_auto,c_limit,w_550,q_auto/v1595118464/campground-photos/nfbyxco6ulfuq9kxn7pr.jpg');
