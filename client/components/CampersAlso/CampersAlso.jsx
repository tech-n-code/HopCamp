      ...
      <div className="campers-also-root-container">
        <div className="camp-also-container-centered">
          <div className="d-flex w-100">
            <span className="camp-also-title">Campers also viewed...</span>
          </div>
          <CampersAlsoCarousel />
        </div>
      </div>
...
const CampersAlsoCarousel = () => {
  ...
  const groupedCampersAlso = campersAlsoData.reduce(
    ...
    <div className="camp-spot-card">
      ...
      <div className="camp-spot-rating-container">
        ...
        <div className="pt-1">
          ...
          <span className="camp-spot-money-txt">${props.price}</span>
