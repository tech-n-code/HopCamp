            ...
            <div className="land-sites d-flex flex-row p-2">
              <div className="d-flex flex-row left-border border-start border-gray px-2">
                <div className="d-flex flex-column align-items-center me-5">
                  ...
                  >
                    <path
                      d="M18.364 8H11.09v3a2 2 0 01-2 2H6.222a2 2 0 01-2-2V6.111a1.111 1.111 0 10-2.222 0v11.98a.91.91 0 101.818 0V16h16.364v2.09a.91.91 0 101.818 0V12c0-2.21-1.627-4-3.636-4z"
                      fill="currentColor"
                    ></path>
                    <path
                      d="M10 9.5a2.5 2.5 0 11-5 0 2.5 2.5 0 015 0z"
                      fill="currentColor"
                    ></path>
                  </svg>
                  <span>1 lodging</span>
              ...
              <div className="modal-header">
                <div>
                  <button
                    ...
                    aria-label="Close"
                  ></button>
                  <h1 className="modal-title fs-5 pt-3 fw-bold" id="modalLabel">
                    About
                  </h1>
                </div>
              </div>
              <div className="modal-body">{land.description}</div>
            </div>
          </div>
        </div>
              ...
              <div className="modal-header">
                <div>
                  <button
                    ...
                    aria-label="Close"
                  ></button>
                  <h1 className="modal-title fs-4 pt-3 fw-bold" id="modalLabel">
                    Activities
                  </h1>
