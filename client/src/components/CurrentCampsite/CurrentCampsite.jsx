import styles from "./CurrentCampsite.module.css";
import ShareComponent from "./ShareComponent";

function CurrentCampsite() {
    ...
    <div className={styles.currentCampSite}>
      <nav className={`${styles.navState} fw-bolder`} aria-label="breadcrumb">
        <ol className="breadcrumb m-0">
          <li className="breadcrumb-item">
            <a
              href="https://www.hipcamp.com/en-US/d/united-states/camping/all"
          ...
          <li className="breadcrumb-item">
            <a
              href="https://www.hipcamp.com/en-US/d/united-states/california/camping/all"
              className="text-body-secondary"
            >
              California
            </a>
      ...
      <div id="rating">
        <ol className="d-flex gap-1 align-items-center p-0">
          ...
          <li className="fw-bold" role="button">
            <a href="https://www.hipcamp.com/en-US/land/california-salmon-creek-ranch-4kk9hl90/reviews">
              1098 reviews
            </a>
          </li>
          <span className="fw-bold fs-5">·</span>
      ...
      <div id="buttonGroup">
        <ol className="d-flex gap-3 p-0">
          <button
            className={`ps-4 pe-4 fw-semibold rounded-3 ${styles.btOrange}`}
          >
            {" "}
            <a href="#campSites" className="text-white text-decoration-none">
              See available sites
            </a>
          </button>
          ...
          <div className="btn-group">
            ...
            <div
              className="shadow dropdown-menu text-center rounded-3 mt-2 p-4"
              style={{ width: "550px" }}
              id="dropdown-Share"
            >
              <ShareComponent />
            ...
            <div className="modal-header">
              <div className="pb-4">
                <button
                  ...
                  aria-label="Close"
                ></button>
                <h1 className="modal-title fs-3 pt-3" id="exampleModalLabel">
                  Save to list
                </h1>
              </div>
            </div>
              ...
              <div>
                <div className="d-flex align-items-center gap-3">
                  <img
                    ...
                    src="https://static.vecteezy.com/system/resources/previews/000/376/259/original/plus-vector-icon.jpg"
                  ></img>
